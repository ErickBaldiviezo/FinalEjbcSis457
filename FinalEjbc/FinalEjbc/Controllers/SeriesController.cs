...
using FinalEjbc.Models;
using Microsoft.AspNetCore.Authorization;

namespace FinalEjbc.Controllers
{
    [Authorize]
    public class SeriesController : Controller
    {
        private readonly FinalEjbcContext _context;

        public SeriesController(FinalEjbcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalEjbcContext.Series'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
